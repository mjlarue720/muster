...
class PersonController {
    ...
    def create() {
        ...
        println("DBG create executed")
        println(parameters)
        Person person = new Person(params)
        person.email=parameters["user[email]"]
        person.description="somebody"
        person.name = parameters["user[name]"]
        person.password = parameters["user[user_password]"]
        person.save(true)
